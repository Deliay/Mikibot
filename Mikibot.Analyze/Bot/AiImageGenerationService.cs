    ...
    public partial class AiImageGenerationService
    {
        ...
        private static readonly Dictionary<string, List<string>> promptMap = new()
        {
            ...
            { "白裙", new () {
                ...
                "<lora:miki-v2+v3:-w->, castle, white dress, skirt, off-shoulder dress, bare shoulders, ",
                "<lora:miki-v2+v3:-w->, dormitory, white dress, skirt, off-shoulder dress, bare shoulders, ",
                "<lora:miki-v2+v3:-w->, street, plant, white dress, skirt, off-shoulder dress, bare shoulders, ",
                "<lora:miki-v2+v3:-w->, street, plant, white dress, skirt, off-shoulder dress, bare shoulders, straw hat, ",
                "<lora:miki-v2+v3:-w->, beach, sunshine, white dress, skirt, off-shoulder dress, bare shoulders, straw hat, ",
                "<lora:miki-v2+v3:-w->, flowers meadows, sunshine, white dress, skirt, off-shoulder dress, bare shoulders, straw hat, ",
            } },
            { "泳装", new () {
        ...
        private static (string, string, double, int) GetPrompt(string style, string character)
        {
            ...
            var cfgScale = random.Next(100) > 60 ? random.Next(40, 111) / 10D : 8;
