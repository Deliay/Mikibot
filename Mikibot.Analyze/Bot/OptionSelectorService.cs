...
public partial class OptionSelectorService(IMiraiService miraiService, ILogger<OptionSelectorService> logger)
    : MiraiGroupMessageProcessor<OptionSelectorService>(miraiService, logger)
{
