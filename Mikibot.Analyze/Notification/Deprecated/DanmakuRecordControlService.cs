...
namespace Mikibot.Analyze.Notification
{
        ...
        IOssService oss)
    {
        ...
        public BiliLiveCrawler Crawler { get; } = crawler;
        public ILogger<DanmakuRecordControlService> Logger { get; } = logger;
        public IMiraiService Mirai { get; } = mirai;
        public LiveStatusCrawlService LiveStatus { get; } = liveStatus;
        public IOssService Oss { get; } = oss;
