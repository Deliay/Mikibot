...
{
    private readonly RawWebSocketWorker _worker = new();
    private readonly CancellationTokenSource _csc = new();
    ...
    private static IEnumerable<IData> ProcessPacket(ReadOnlyMemory<byte> raw)
    {
